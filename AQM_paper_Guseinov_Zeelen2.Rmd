...
lost_campaigns_table <- read.csv('datasources/lost_campaigns.csv') %>% dplyr::select(-1)
```
...
# For a Full Model - ova_ifi_full_m1
...
```{r h2-REWB-model, fig.cap="Simulated predicted probabilities of a violent tactic choice over a range of IFI values - baseline vs. REWB", fig.align = 'center', out.width="85%", include = TRUE}
